...
sendToken(res,user,"Resistered successfully",201);
...
if(!user){
    return next(new ErrorHandler("user dosen't exists",401));
}
...
export const addToPlaylist = catchAsyncError( async( req,res,next) => {
 ...
 export const updateUserRole = catchAsyncError( async( req,res,next) => {
    ...
    if(!user) returnnext(new ErrorHandler("User not found",404))
